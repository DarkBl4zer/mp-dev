...
<div class="card" style="margin-top: 30px;">
    <div class="card-header">
        <strong>EDITAR LISTA <?php echo e($lista); ?></strong>
    </div>
    <div class="card-body">
        <?php if($id != 13): ?>
            <div class="row">
        ...
        <div class="row top10">
            <div class="col-sm-12 text-center">
                <a href="<?php echo e(route('gestion')); ?>" class="btn btn-primary btn-block btn-sm"><i class="fas fa-undo-alt"></i>&nbsp;&nbsp; REGRESAR</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <form action="<?php echo e(route('gestion_lista_guardar')); ?>" id="formCrearEditar" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<script type="text/javascript">
var idLista = <?php echo e($id); ?>;
var masItem = "<?php echo e($masItem); ?>";
</script>
    <!-- Códigos para Plan de Trabajo -->
    <script src="<?php echo e(asset("assets/js/gestion/editar.js")); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("plantilla.base", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mp\resources\views/gestion/editar.blade.php ENDPATH**/ ?>