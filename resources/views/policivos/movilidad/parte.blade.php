...
<div class="card" style="margin-top: 30px;">
    <div class="card-header">
        <strong>POLICIVOS / MOVILIDAD - PARTE</strong>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-sm-3">
                <button onclick="NuevaActuacion();" class="btn btn-success btn-block btn-sm"><span class="fa fa-plus-circle"> </span>&nbsp;&nbsp; INTERVENCIÓN PARTE</button>
            </div>
        </div>
        <div class="row top10">
            <div class="col-sm-12">
...
@php echo $festivos; @endphp
    ...
    <script src="{{asset("assets/js/policivos/movilidad/parte.js")}}"></script>
@endsection