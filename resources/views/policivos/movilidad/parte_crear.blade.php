...
@endsection
@section('modalBody')
<form action="{{route('movilidad_parte_guardar')}}" id="formularioParte" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row top10" id="row_estado_audiencia" style="display: none;">
        <div class="col-md-12">
            ...
            <select class="form-control" id="estado_audiencia" name="estado_audiencia" onchange="$('#M' + this.id).hide();"> 
            </select>
    ...
    <div class="row top10">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="numero" name="numero" autocomplete="off" maxlength="8" minlength="8" onkeyup="this.value = FiltrarCaracteres(this, 'numeros');$('#M' + this.id).hide();" onblur="ValidarMinimo(this.id, 8);" />
