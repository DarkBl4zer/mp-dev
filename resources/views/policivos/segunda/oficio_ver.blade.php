...
@section('modalBody')
    <div class="row">
        <div class="col-md-12">
            <button type="button" class="btn btn-info btn-block btn-sm" data-toggle="modal" data-target="#modalDenunciados"><i class="fas fa-street-view"></i>&nbsp;&nbsp; QUERELLANTE</button>
        </div>
    </div>
    <div class="row top10">
        <div class="col-md-6">
    ...
    <div class="row top10">
        <div class="col-md-12">
            ...
            <textarea class="form-control" rows="2" disabled style="font-size: 12px; resize: none;">{{$campos->autoridad}}</textarea>
        </div>
    </div>
    <div class="row top10">
        <div class="col-md-6">
            <label class="minilabel">Número querella</label>
            <textarea class="form-control" rows="2" disabled style="font-size: 12px; resize: none;">{{$campos->numero}}</textarea>
        </div>
        <div class="col-md-6">
            <label class="minilabel">Clase querella</label>
