...
@endsection
@section('modalBody')
<form action="{{route('segunda_parte_guardar')}}" id="formularioParte" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row top10">
        <div class="col-md-6">
            ...
            <select class="form-control" id="tipo_actuacion" name="tipo_actuacion" onchange="$('#M' + this.id).hide();CambioTipoActuacion(this.value);" >
        ...
        <div class="col-md-6">
            ...
            <select class="form-control" id="clase_diligencia" name="clase_diligencia" onchange="$('#M' + this.id).hide();">
            </select>
    ...
    <div class="row top10">
        <div class="col-md-12">
            <label class="requerido minilabel">Autoridad administrativa especial de policía</label>
            <select class="select2 form-control" id="autoridad" name="autoridad" onchange="$('#M' + this.id).hide();"> 
                @php echo $parametricas['autoridad']; @endphp
            </select>
            <span id="Mautoridad" class="msjRequerido"></span>
        </div>
    </div>
    <div class="row top10">
        <div class="col-md-6">
            <label class="requerido minilabel">Número de querella</label>
            <input type="text" class="form-control" id="numero" name="numero" autocomplete="off" maxlength="23" minlength="23" onkeyup="this.value = FiltrarCaracteres(this, 'cordis');$('#M' + this.id).hide();" onblur="ValidarMinimo(this.id, 23);" />
            <span id="Mnumero" class="msjRequerido"></span>
        </div>
        <div class="col-md-6">
            <label class="requerido minilabel">Clase de querella</label>
            <select class="form-control select2" id="clase" name="clase" onchange="$('#M' + this.id).hide();">
                @php echo $parametricas['clase']; @endphp
            </select>
    ...
    <div class="row top10">
        <div class="col-md-12">
            ...
            <textarea class="form-control" id="observaciones" rows="3" cols="10" maxlength="1000" onkeyup="this.value = FiltrarCaracteres(this, 'textos', true);$('#M' + this.id).hide();"></textarea>
