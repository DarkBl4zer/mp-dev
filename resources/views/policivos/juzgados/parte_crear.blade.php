...
@endsection
@section('modalBody')
<form action="{{route('juzgados_parte_guardar')}}" id="formularioParte" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row top10">
        <div class="col-md-12">
            ...
            <select class="select2 form-control" id="despacho_judicial" name="despacho_judicial" onchange="$('#M' + this.id).hide();"> 
                @php echo $parametricas['despachoj']; @endphp
            </select>
    ...
    <div class="row top10">
        <div class="col-md-6">
            <label class="requerido minilabel">Número proceso</label>
            <input type="text" class="form-control" id="numero" name="numero" autocomplete="off" maxlength="21" minlength="21" onkeyup="this.value = FiltrarCaracteres(this, 'cordis');$('#M' + this.id).hide();" onblur="ValidarMinimo(this.id, 21);" />
            <span id="Mnumero" class="msjRequerido"></span>
        </div>
        <div class="col-md-6">
            <label class="requerido minilabel">Clase proceso</label>
            <select class="form-control select2" id="clase" name="clase" onchange="$('#M' + this.id).hide();">
                @php echo $parametricas['proceso']; @endphp
            </select>
