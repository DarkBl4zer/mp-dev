...
@endsection
@section('modalBody')
<form action="{{route('juzgados_oficio_guardar')}}" id="formularioOficio" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row top10">
        <div class="col-md-12">
            ...
            <select class="select2 form-control" id="despacho_judicial" name="despacho_judicial" onchange="$('#M' + this.id).html('').hide();"> 
    ...
    <div class="row top10">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="numero" name="numero" autocomplete="off" maxlength="21" minlength="21" onkeyup="this.value = FiltrarCaracteres(this, 'cordis');$('#M' + this.id).html('').hide();" onblur="ValidarMinimo(this.id, 21);" />
