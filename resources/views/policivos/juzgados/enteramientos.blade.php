...
@section('titulo')
POLICIVOS / JUZGADOS - NOTIFICACIONES
@endsection
@section('plugins')
<!-- DataTables CSS-->
...
<div class="card" style="margin-top: 30px;">
    <div class="card-header">
        <strong>POLICIVOS / JUZGADOS - NOTIFICACIONES</strong>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-sm-3">
...
@php echo $festivos; @endphp
    ...
    <script src="{{asset("assets/js/policivos/juzgados/notificaciones.js")}}"></script>
@endsection