...
<body>
        ...
        <div class="row top10">
            <div class="col-sm-12">
                <table id="tablaDatos" class="table table-striped table-bordered" style="width:100%; font-size: 14px; display: none;">
                    <thead>
                        <tr>
                            <th>NÚMERO DE AGENCIA ESPECIAL</th>
                            <th>FECHA CREACIÓN</th>
                            <th>DELEGADA ASIGNADA</th>
                            <th>NOMBRE DEL MINISTERIO PÚBLICO</th>
                            <th>NO. NOTICIA CRIMINAL</th>
                            <th>DESPACHO JUDICIAL</th>
                            <th>NOMBRE UNIDAD</th>
                            <th>ADECUACIÓN TÍPICA ACTUAL</th>
                            <th>CRITERIOS DE CREACIÓN</th>
                            <th>JUSTIFICACIÓN</th>
                            <th>SINTESIS DE LOS HECHOS</th>
                            <th>ACTUACIÓN PROCESAL</th>
                            <th>ESTADO</th>
                            <th>JUSTIFICACIÓN FIN AGENCIA</th>
                            <th>USUARIO CREA</th>
                            <th>TIPO DE VÍCTIMA</th>
                            <th>CORRECCIÓN DELITO</th>
                            <th>CORRECCIÓN DESPACHO JUDICIAL</th>
                            <th>INDICIADOS</th>
                            <th>VÍCTIMAS</th>
    ...
    <script src="{{asset("assets/js/estadisticas/informe_detalle7.js")}}"></script>
</body>
</html>