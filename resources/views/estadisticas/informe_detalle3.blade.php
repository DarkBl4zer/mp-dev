...
<body>
    ...
    <div class="container-fluid" style="width: 5000px;">
        <div class="row top10">
            <div class="col-sm-12">
                <h5 id="titulo_informe">
                    @if ($parametros['delegada'] == "3")
                    <th>INFORME DETALLE MOVILIDAD - {{$parametros['nombre_actuacion']}}</th>
                    @endif
                    @if ($parametros['delegada'] == "4")
                    <th>INFORME DETALLE JUZGADOS - {{$parametros['nombre_actuacion']}}</th>
                    @endif
                    @if ($parametros['delegada'] == "5")
                    <th>INFORME DETALLE SEGUNDA - {{$parametros['nombre_actuacion']}}</th>
                    @endif
                </h5>
            </div>
        </div>
                ...
                <table id="tablaDatos" class="table table-striped table-bordered" style="width:100%; font-size: 14px; display: none;">
                    <thead>
                        <tr>
                            ...
                            <th>TIPO DE INTERVENCIÓN GENERAL</th>
                            <th>ENTIDADES</th>
                            ...
                            <th>CLASE CONTRAVENCIÓN</th>
                            <th>AUTORIDAD ADMINISTRATIVA ESPECIAL DE POLICÍA</th>
                            <th>OBSERVACIONES</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            @endif
                            @if ($parametros['delegada'] == 3)
                            <th class="tabla_buscar"><input type="text" class="form-control" onkeyup="FiltrarColumna(20, this.value);" placeholder="Filtrar..."></th>
                            @endif
                        </tr>
                    </tfoot>
                </table>
    ...
    <script src="{{asset("assets/js/estadisticas/informe_detalle3.js")}}"></script>
</body>
</html>