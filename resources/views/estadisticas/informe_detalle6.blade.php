...
<body>
        ...
        <div class="row top10">
            <div class="col-sm-12">
                <h5 id="titulo_informe">
                    ...
                    <th>INFORME DETALLE PMR - PENALES1</th>
                    @endif
                    @if ($parametros['actuacion'] == "2")
                    <th>INFORME DETALLE PMR - PENALES2</th>
                    @endif
                    @if ($parametros['actuacion'] == "3")
                    <th>INFORME DETALLE PMR - MOVILIDAD</th>
                    @endif
                    @if ($parametros['actuacion'] == "4")
                    <th>INFORME DETALLE PMR - JUZGADOS</th>
                    @endif
                    @if ($parametros['actuacion'] == "5")
                    <th>INFORME DETALLE PMR - SEGUNDA</th>
                    @endif
                </h5>
            </div>
        </div>
        ...
        <div class="row top10">
            <div class="col-sm-12">
                <table id="tablaDatos" class="table table-striped table-bordered" style="width:100%; font-size: 14px; display: none;">
                    @if ($parametros['actuacion'] == "1" || $parametros['actuacion'] == "2")
                        <thead>
                            <tr>
                                <th>ID</th>
    ...
    <script type="text/javascript">
        var csrf = "{{csrf_token()}}";
        var delegada = "{{$parametros['actuacion']}}";
        var tipo = "{{$parametros['tipo']}}";
        var actuacion = "{{$parametros['actuacion']}}";
        var rol = {{$rol}};
    </script>
    <!-- Códigos para Detalle del reporte -->
    <script src="{{asset("assets/js/estadisticas/informe_detalle6.js")}}"></script>
</body>
</html>