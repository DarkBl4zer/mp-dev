...
@section('modalTitle')
AGENCIA ESPECIAL #{{sprintf("%03d", $agencia->numero_agencia_especial)}}
@endsection
...
<form action="{{route('coordinador_guardar')}}" id="formularioAgencia" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" name="numero_agencia_especial" class="form-control" id="numero_agencia_especial" value="{{$agencia->numero_agencia_especial}}" style="cursor: not-allowed;" readonly/>
    ...
    <div class="row top10">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="noticia_criminal" name="noticia_criminal" autocomplete="off" maxlength="21" minlength="21" onkeyup="this.value = FiltrarCaracteres(this, 'numeros');$('#M' + this.id).hide();" onblur="ValidarMinimo(this.id, 21);" value="{{$agencia->noticia_criminal}}" />
    ...
    <div class="row top10">
        <div class="col-md-6"> 
            ...
            <input type="text" class="form-control" name="nombre_unidad"  id="nombre_unidad" style="cursor: not-allowed;" value="{{$agencia->despacho_judicial}}" readonly/>
    ...
    <div class="row top10">
        <div class="col-md-12">
            ...
            <textarea class="form-control" id="justificacion" rows="3" cols="10" maxlength="1000" onkeyup="this.value = FiltrarCaracteres(this, 'textos', true);$('#M' + this.id).hide();">{{$agencia->justificacion}}</textarea>
...
<div class="col-md-6 text-right" id="btnRegistrar">
    <button type="button" class="btn btn-primary btn-block btn-sm" onclick="RegistrarActuacion();"><span class="fa fa-save"> </span>&nbsp;&nbsp; ACTUALIZAR AGENCIA</button>
</div>
...
var phpDelegada = {{$agencia->delegada}};
var phpMP = "{{$agencia->nombre_ministerio}}";
var idAEDisponible = {{$agencia->numero_agencia_especial}};
IniciarControlesModal(1);
if (idAEDisponible < 41) {
    $('#fecha_creacion').daterangepicker({
        ...
        drops: 'down',
        maxDate: moment(),
        startDate: "{{$agencia->fecha_creacion}}",
        locale: SpanishDP,
