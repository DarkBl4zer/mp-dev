...
@endsection
@section('modalBody')
<form action="{{route('penales2_agencias_informe_guardar')}}" id="formularioInforme" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="button" class="btn btn-info btn-block btn-sm" data-toggle="modal" data-target="#modalDatosAgencia" data-toggle="tooltip" data-html="true" title="Ver datos de constitución de la agencia especial"><i class="fas fa-balance-scale"></i>&nbsp;&nbsp; DATOS CONSTITUCIÓN AGENCIA ESPECIAL</button>
        </div>
    </div>
