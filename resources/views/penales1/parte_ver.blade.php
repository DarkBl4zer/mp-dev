    ...
    <div class="row top10">
        ...
        @if ($campos->archivo_dt != '')
            <div class="col-md-6">
                ...
                <a href="/penales1/archivo/{{$campos->archivo_dt}}" class="form-control" style="font-size: 12px; min-height: 38px; height: 100%; color: #17a2b8; cursor: pointer; padding-top: 8px;">{{$campos->archivo_or}}</a>
            </div>
        @endif
    </div>
    <div class="row top10">
