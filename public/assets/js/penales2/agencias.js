...
function CargarDatos() {
    _POST('json', '/penales2/agencias/tabla', {}, function (result){
        if (result.length > 0) {
            LlenaTabla(result);
        } else {
...
function Int(id) {
    clicksMas = 0;
    var datos = {id: id};
    _POST('html', '/penales2/agencias/intervencion', JSON.stringify(datos), function (result){
...
function VerIntervenciones(id){
    ...
    var datos = {id: id};
    _POST('html', '/penales2/agencias/intervenciones', JSON.stringify(datos), function (result){
        $('#espacioModal').html(result);
    });
}
...
function VerOficio(id) {
    clicksMas = 0;
    var datos = {id: id};
    _POST('html', '/penales2/oficio/modal_ver', JSON.stringify(datos), function (result){
        $('#espacioModal').html(result);
    });
}
...
function Inf(id, bloqueo){
    clicksMas = 0;
    var datos = {id: id};
    _POST('html', '/penales2/agencias/informe', JSON.stringify(datos), function (result){
        $('#espacioModal').html(result);
        if (bloqueo) {
            $('#btnRegistrar').html('');
            $('#formulario').hide();
...
function VerInformes(idAE){
    ...
    $('.modal-backdrop').remove();
    var datos = {idAE: idAE};
    _POST('html', '/penales2/agencias/informes', JSON.stringify(datos), function (result){
        $('#espacioModal').html(result);
    });
}
